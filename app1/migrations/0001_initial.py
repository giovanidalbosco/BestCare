...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.IntegerField(choices=[(1, 'Refeicao'), (2, 'Medicamento'), (3, 'Consulta Medica'), (4, 'Fisioterapia'), (5, 'Atividade Fisica'), (6, 'Atividade Cultural'), (7, 'Atividade Recreativa')], default='')),
                ('event_frequencia', models.IntegerField(choices=[(1, 'Horario'), (2, 'Diario'), (3, 'Semanal'), (4, 'Mensal'), (5, 'Dias Alternados'), (6, 'Criterio Medico')], default='')),
                ('event_dose', models.IntegerField(choices=[(1, '1/4'), (2, '1/2'), (3, '3/4'), (4, '1'), (5, '1 + 1/4'), (6, '1 + 1/2'), (7, '1 + 3/4')], default=0)),
                ('description', models.TextField()),
                ('start_time', models.DateTimeField()),
                ('end_time', models.DateTimeField()),
                ('event_consumo_nome', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app1.uso_consumo', verbose_name='Uso_consumo')),
